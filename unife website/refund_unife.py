...
# URL del server
base_url = "http://ctf.unife.it:5100/"
...
with concurrent.futures.ThreadPoolExecutor() as executor:
    ...
    for _ in range(15):  # Creiamo più pagamenti da 100
        futures.append(executor.submit(authorize_payment, 68))
    ...
    futures = [executor.submit(refund_payment, i) for i in range(15)]
